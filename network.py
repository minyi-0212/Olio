        ...
        if style_data is None:
            ...
            for content_idx in range(content_size):
                for style_index in range(len(style_data)):
                    channel, height, width = style_data[style_index].shape
                    ...
                    style_out = self.stylebank_net[style_label[style_index]](style_data[style_index].view(1, channel, height, width))  # 128*H*W
